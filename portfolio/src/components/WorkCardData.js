...
import pro2 from "../assets/Picture1.jpg"
...
const ProjectCardData = [
    {
        imgsrc: pro5,
        title: "JobSearch",
        text: "A job search application built using React Native bundled for Android and iOS with JSearch API integration and rendering",
        view:"https://drive.google.com/file/d/11X6RV8wFu1ZOIUXZ8fU19GWMXSWLbT_p/view?usp=sharing",
        source: "https://github.com/AkshayPrasad25/React_Native_Jobs"
    },
    {
        imgsrc: pro1,
    ...
    {
        imgsrc: pro4,
        title: "Traffic Sense Filming & Editing",
        text: "A smart traffic management system, that aims to reduce traffic congestions and make commuting fast, safe and painless. Edited using Adobe Premier Pro",
        view:"https://youtu.be/iCuPKTIaC1o?si=CF94kJO-hMib0bfK"
    }
]
